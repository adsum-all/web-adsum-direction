...
// browser looks like pagination until the base has two thousand members, at which
// point every screen doing it becomes slow at once and nobody remembers why.
//
// The size travels to the server, the count comes back with the rows, and the
// component says where the reader is: "1 à 10 sur 248". A reader who does not know
// how much sits behind the page cannot tell a short list from a truncated one.
